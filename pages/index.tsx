...
const Home: NextPage = () => {
  ...
  return (
    <div className='bg-gray-100 w-full h-screen flex justify-center flex-col items-center max-h-screen'>
      <Head>
    ...
    <div className='w-full px-1 md:px-0 overflow-y-auto mb-4 md:w-1/2 mt-10 flex flex-col justify-center items-center gap-2'>
      {
